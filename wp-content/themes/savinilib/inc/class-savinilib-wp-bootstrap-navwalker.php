...
/**
 * Class Name: savinilib_wp_bootstrap_navwalker
...
class savinilib_Wp_Bootstrap_Navwalker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( 0 == strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
			...
			$item_output .= ( $args->has_children ) ? ' </a><span class="savinilib-dropdown"></span>' : '</a>';
