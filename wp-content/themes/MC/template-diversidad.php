...
<div class="cine-section">
    <div class="mycontainer cine-container">
        <div class="main-title-wrapper cine">
            <h1 class="main-title"><strong><?php _e( 'Diversidad e interculturalidad', 'my_mc' ); ?></strong></h1>
        </div>
        <div class="experiencias-content-wrapper educacion">
            ...
            <div class="col-wrapper">
                <?php 
                    ...
                    $gallery = get_post_meta(get_the_ID(), 'galeria_diversidad', true);  
