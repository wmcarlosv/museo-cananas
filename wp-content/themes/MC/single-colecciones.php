...
<div class="exp-header-section">
    ...
    <div class="mycontainer header">
        <a data-w-id="0a145c33-6e16-f8fc-bfd4-cb427c448321" href="https://www.eventbrite.com.mx/e/zeries-creando-el-mundo-que-queremos-charla-en-ingles-tickets-142800575365?aff=ebdssbonlinesearch" target="_blank" class="bot-n-tickets w-inline-block"> <div class="boton-tickets-text">
                <?php _e( 'Compra', 'my_mc' ); ?>
                <br>
                <?php _e( 'tus', 'my_mc' ); ?>
                <br>
            ...
            <div class="collection-list-wrapper-3">
                <div class="collection-list-3">
                    <?php for($i=0; $i<1000; $i++): ?>
                        ...
                        <?php if(PG_Image::getUrl( get_post_meta( get_the_ID(), 'gallery_image_'.$i.'_image', true ), 'full' )): ?>
                        <div class="coleccion-multi-image-item">
                            <img src="<?php echo PG_Image::getUrl( get_post_meta( get_the_ID(), 'gallery_image_'.$i.'_image', true ), 'full' ) ?>" loading="lazy" alt="" class="col-img">
                            <p class="cine-parrafo"><?php echo get_post_meta( get_the_ID(), 'image_caption_'.$i.'_caption', true ); ?></p>
                        </div>
                    <?php else:
                        break;
                    endif; ?>
