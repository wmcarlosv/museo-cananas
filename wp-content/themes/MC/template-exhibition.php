<?php
/*
 Template Name: colecciones post
            ...
            <div class="collection-list-wrapper-3">
                <div class="collection-list-3">
                    <div class="coleccion-multi-image-item">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/7W8Bz6-80.jpg" loading="lazy" alt="" class="col-img">
                        <p class="cine-parrafo"><?php _e( 'Ignacio Aguirre', 'my_mc' ); ?><br><?php _e( 'Paisaje, 1963', 'my_mc' ); ?><br><?php _e( 'Óleo sobre fibracel', 'my_mc' ); ?><br><?php _e( '80X202 cm', 'my_mc' ); ?></p>
                    </div>
                    <div class="coleccion-multi-image-item">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/7W8Bz6-80.jpg" loading="lazy" alt="" class="col-img">
                        <p class="cine-parrafo"><?php _e( 'Ignacio Aguirre', 'my_mc' ); ?><br><?php _e( 'Paisaje, 1963', 'my_mc' ); ?><br><?php _e( 'Óleo sobre fibracel', 'my_mc' ); ?><br><?php _e( '80X202 cm', 'my_mc' ); ?></p>
