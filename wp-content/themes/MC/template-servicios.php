    ...
    <div class="mycontainer cine-container">
        ...
        <div class="tienda-container">
            ...
            <div id="w-node-dca9636e-46c2-30a6-5f1a-cb3bd87e7ad7-154101aa" class="col-wrapper">
                ...
                ?>
                <div class="wide-img-container" style="background: url('<?=$imagen_url?>'); width:100%; height:400px; background-position: 50% 0%; background-size: contain; background-repeat: no-repeat;"></div>
            </div>
