    ...
    <div class="mycontainer cine-container">
        ...
        ?>
                    <div style="padding-top: 25px;">
                        <div style="width:85%; margin:10px auto; padding: 10px 5px;">
                            <h2 class="heading-experiencias"><?php echo get_the_title(); ?></h2>
                            <b style="font-size: 14px; font-weight: 550;">
                                <?php  echo get_post_meta(get_the_ID(), 'directorio_cargo', true); ?>
                            </b>
                            <br />
                            <br />
                            <div>
                                <p>
                                    Domicilio: <?php  echo get_post_meta(get_the_ID(), 'directorio_domicilio', true); ?>
                                </p>

                                <p>
                                    Teléfono: <?php  echo get_post_meta(get_the_ID(), 'directorio_telefono', true); ?>
                                </p>

                                <p>
                                    Correo electrónico: <?php  echo get_post_meta(get_the_ID(), 'directorio_correo', true); ?>
                                </p>
