    ...
    <div class="mycontainer cine-container">
        ...
        <div class="experiencias-content-wrapper educacion">
            <div class="col-wrapper left">
                <?php 
                    $imagen_escuela = get_post_meta(get_the_ID(), 'foto_mision', true);
            ...
            <div class="col-wrapper">
                <div class="experiencia-container">
                    <h2 class="heading-experiencias"><?php echo get_post_meta( get_the_ID(), 'mision_institucional_titulo', true ); ?></h2>
                    <p class="cartelera-sinopsis"><?php echo get_post_meta( get_the_ID(), 'mision_institucional_texto', true ); ?></p>
                </div>
                <div class="experiencia-container">
                    <h2 class="heading-experiencias"><?php echo get_post_meta( get_the_ID(), 'vision_institucional_titulo', true ); ?></h2>
                    <p class="cartelera-sinopsis"><?php echo get_post_meta( get_the_ID(), 'vision_institucional_texto', true ); ?></p>
                </div>
                <div class="experiencia-container">
                    <h2 class="heading-experiencias"><?php echo get_post_meta( get_the_ID(), 'valores_institucionales_titulo', true ); ?></h2>
                    <p class="cartelera-sinopsis" style="white-space: pre-wrap;"><?php echo get_post_meta( get_the_ID(), 'valores_institucionales_texto', true ); ?></p>
                </div>
            </div>
        </div>
    </div>
